...
Бэкапы мы делаем как самый-самый последний вариант восстановления доступа, восстановления наших данных. Либо для того чтобы достаточно быстро переехать на новый кластер. В целом проблемы доступности данных мы должны решить за счет репликации.
